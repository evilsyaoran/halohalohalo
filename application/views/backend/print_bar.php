...
<div id="pesan">
	...
	<br />
	<table>
		<tr class='firstrow'><th>No</th><th>Pesanan</th><th>Method</th><th>Beans</th><th>Susu</th><th>Jumlah</th></tr>
		<?php
			$no=1;
			$total=0;
			foreach($isi as $i)
			{
				echo "<tr><td>$no</td><td>$i->nama_produk</td><td>$i->method</td><td>$i->beans</td><td>$i->add_milk</td><td>$i->jumlah</td></tr>";
